...
export default function TeacherCard({ courseId }: Props) {
    return (
        <nav className="flex flex-col gap-3 text-sm">
            ...
            <AlertDialog>
                <AlertDialogTrigger asChild>
                    <div className="gap flex flex-row items-center justify-start">
                        <a className="flex cursor-pointer flex-row items-center gap-3 rounded-xl px-1 py-1 text-black hover:bg-black hover:text-white dark:text-black">
                        ...
                        <AlertDialogTrigger>
                            <a className="flex cursor-pointer flex-row">
                                <div className="group relative mb-1 ml-2 items-center">
                                    ...
                                    >
                                        <Download size={20} className="w-full text-black hover:text-white dark:text-black" />
                                    </button>

                                    <div className="group relative">
                                        <button className="absolute top-full left-1/2 mt-2 w-max -translate-x-1/2 scale-0 transform cursor-pointer rounded rounded-full !bg-black px-2 py-1 text-sm text-black opacity-0 transition-all duration-200 group-hover:scale-100 group-hover:text-white group-hover:opacity-100">
                                            Download PPT
                                        </button>
                                    </div>
                                </div>
            ...
            <AlertDialog>
                <AlertDialogTrigger asChild>
                    <a className="w-fit cursor-pointer rounded-xl px-1 py-1 text-black hover:bg-black hover:text-white dark:text-black">
                        Go to Forums Page
                    </a>
                </AlertDialogTrigger>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogCancel className="cursor-pointer">Cancel</AlertDialogCancel>
                        <AlertDialogAction asChild>
                            <Link className="cursor-pointer" href={`/classroom/${courseId}`}>
                                Yes
                            </Link>
                        </AlertDialogAction>
                    </AlertDialogFooter>
            ...
            <AlertDialog>
                <AlertDialogTrigger asChild>
                    <Button className="mt-3 flex cursor-pointer items-center justify-center bg-white text-black hover:bg-black hover:text-white dark:text-black dark:hover:bg-gray-400 dark:hover:text-white">
                ...
                <AlertDialogContent className="max-w-[95vw] sm:max-w-lg">
                    ...
                    <div className="flex flex-col gap-4">
                        <Card
                            onClick={() => router.visit(route('assignments.create', { courseId: courseId }))}
                            className="cursor-pointer transition hover:bg-gray-600 hover:text-white dark:hover:bg-gray-600"
                        >
                        ...
                        <Card
                            ...
                            className="hover:text-whitedark:hover:bg-black cursor-pointer transition hover:bg-gray-600 dark:hover:bg-gray-600"
                        >
                            <CardContent className="flex flex-col items-center justify-center p-6">
