...
export default function EventBackground() {
    ...
    return (
        <div className="min-h-screen snap-y snap-mandatory overflow-y-scroll scroll-smooth">
            <section className="flex h-screen snap-start flex-col items-center bg-black text-white">
            ...
            <section className="flex h-screen snap-start flex-col items-start bg-black text-white">
